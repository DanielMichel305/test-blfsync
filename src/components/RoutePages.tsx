...
export function PaymentResultPage({ outcome, onContinue, onTryAgain }: { outcome: 'success' | 'failure'; onContinue: () => void | Promise<void>; onTryAgain: () => void | Promise<void> }) {
